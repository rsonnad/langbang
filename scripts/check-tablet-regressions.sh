...
account_prefs="app/src/main/kotlin/com/sponic/langbang/data/AccountPrefsStore.kt"
...
require_fixed "$verbs" "label = \"Hlp verb\"" "helper verb phrase checkbox"
...
require_fixed "$verbs" "No phrases match the selected word types yet." "no short fallback phrase playback"
...
require_fixed "$account_prefs" "customItemGateSatisfied" "custom phrase account gate preference"
